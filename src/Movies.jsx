...
import {datefilm} from "./Date"
export default function Opening() {
  
  return (
    <div class="container mx-auto px-4 sm:px-50 lg:px-50 xl:px-60 mt-12" id="Movies">
        <div className="mb-4">
    <h1 className="text-white text-start text-xl sm:text-2xl font-bold">Opening this Week</h1>
